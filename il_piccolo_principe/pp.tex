...
``Gli uomini? Ne esistono, credo, sei o sette. Li ho visti molti anni
fa. Ma non si sa mai dove trovarli. Il vento li spinge qua e la. Non
hanno radici, e questo li imbarazza molto''.
...
\chapter{}
\begin{center}
\includegraphics{./img/chapter19.png}
\end{center}

Il piccolo principe fece l'ascensione di un'alta montagna. Le sole
montagne che avesse mai visto, erano i tre vulcani che gli arrivavano
alle ginocchia. E adoperava il vulcano spento come uno sgabello. ``Da
una motagno alta come questa'', si disse perchio, ``vedro di un colpo
tutto il pianeta, e tutti gli uomini\ldots{}'' Ma non vide altro che
guglie di roccia bene affilate.

``Buon giorno'', disse a caso.

``Buon giorno\ldots{} buon giorno\ldots{} buon giorno\ldots{}'' rispose
l'eco.

``Chi siete?'' disse il piccolo principe.``Chi siete?\ldots{} chi
siete?.. chi siete?\ldots{}'' rispose l'eco.

\begin{center}
\includegraphics{./img/19a.png}
\end{center}
